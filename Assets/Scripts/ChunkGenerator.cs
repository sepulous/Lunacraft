...
//                 else
//                 {
//                     ChunkHelpers.GenerateChunk(newChunkRow[chunkZ + maxChunkExtent], newChunk, currentPlayerChunkZ + chunkZ, moonData);
...
//                 else
//                 {
//                     ChunkHelpers.GenerateChunk(newChunkRow[chunkX + maxChunkExtent], currentPlayerChunkX + chunkX, newChunk, moonData);
...
//                 {
//                     ChunkHelpers.GenerateChunk(loadedChunks[chunkX + maxChunkExtent, chunkZ + maxChunkExtent], chunkX, chunkZ, moonData);
//                     ChunkHelpers.SaveChunkToFile(loadedChunks[chunkX + maxChunkExtent, chunkZ + maxChunkExtent], moon, chunkX, chunkZ);
//                 }
//                 else
//                 {
//                     ChunkHelpers.GenerateChunk(tempChunk, chunkX, chunkZ, moonData);
